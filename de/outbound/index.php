<?php
	...
	$rowOpts = [
        [
            ...
            'mp_4' => 'https://trk.proficasino.com/click/60?clickid={clickid}',
            'mp_5' => 'https://trk.proficasino.com/click/60?clickid={clickid}',
        ],
        [
        ...
        [
            ...
            'mp_1' => 'https://trk.proficasino.com/click/53?clickid={clickid}',
            'mp_2' => 'https://trk.proficasino.com/click/61?clickid={clickid}',
        ],
        [
            'sp' => 'https://trk.proficasino.com/click/6?clickid={clickid}',
            'mp' => 'https://trk.proficasino.com/click/49?clickid={clickid}',
        ]
	];
